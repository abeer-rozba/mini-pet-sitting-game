...
### Screenshots
![Game Introduction](./images/screenshots/game-introduction.png)
![Main Game Display](./images/screenshots/game-display.png)

### Getting Started
1. Fork and clone this repository to your machine.
2. Open the index.html in a live server.
3. Alternatively, you can navigate to this [live website](https://embarrassed-touch.surge.sh/) to play the game.
